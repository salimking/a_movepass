...
class AllPassView(View):
    ...
    def get(self,request):
        ...
        return render (request,'admin/pass/all_pass.html',context)
...
class SinglePass(View):
    ...
    def get(self,request,id):
        ...
        return render(request,'admin/pass/pass_single.html',context)
...
class ViewApprovedPass(View):
    ...
    def get(self,request):
        ...
        return render(request,'admin/pass/approved_pass.html',context)
...
class ViewDisapprovedPass(View):
    ...
    def get(self,request):
        ...
        return render(request,'admin/pass/disapproved_pass.html',context)
...
class ViewExpiredPass(View):
    ...
    def get(self,request):
        ...
        return render(request,'admin/pass/expired_pass.html',context)